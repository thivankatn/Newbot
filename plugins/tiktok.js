...
*⏳ Duration:* ${l.duration}`
reply(dat)
await conn.sendMessage(from, { video: { url: data.url[0].url}, caption: 'VIDEO NO WATERMARK'}, { quoted: mek })
await conn.sendMessage(from, { document: { url: data.url[1].url }, mimetype: 'audio/mpeg', fileName: 'TikTok Audio' + '.mp3',caption: `` }, { quoted: mek })
} catch (e) {
reply('*Error !!*')
l(e)
}
